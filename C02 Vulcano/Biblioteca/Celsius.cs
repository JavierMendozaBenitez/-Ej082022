...
namespace Biblioteca
{
    public class Celsius
    {
        ...
        static Celsius()
        {
            Celsius.tempRespectoFahrenheit = (Fahrenheit.GetTempRespectoFahrenheit - 32) / 1.8;
        }
        ...
        {
            //return new Fahrenheit(c.temperatura * Celsius.tempRespectoFahrenheit);
        ...
        public static explicit operator Kelvin(Celsius c)//quiero convertir a kelvin los celsius que recibo
        {
            ...
            return new Kelvin((((c.temperatura * 9 / 5) + 32) + 459.67) * 5 / 9);
        }
