...
namespace C01_Herencia_deportiva
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            DirectorTecnico dt0 = new DirectorTecnico("JuanDT", Convert.ToDateTime("11/23/1992".ToString()));
            DirectorTecnico dt1 = new DirectorTecnico("JuanDT", Convert.ToDateTime("11/23/1992".ToString()));
            DirectorTecnico dt2 = new DirectorTecnico("PabloDT", Convert.ToDateTime("12/05/1989".ToString()));
            DirectorTecnico dt3 = new DirectorTecnico("RamonDT", Convert.ToDateTime("05/09/1999".ToString()));
